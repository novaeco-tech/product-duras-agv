...
Welcome to the `duras-agv` flagship product.
...
This is a monorepo that contains the three core components of the `duras-agv` product:
...
3.  Clone this repository: `git clone https://github.com/novaeco-tech/duras-agv.git`
4.  Open the cloned folder in VS Code.
5.  A pop-up will appear: "Folder contains a Dev Container... Reopen in Container?". Click **"Reopen in Container"**.

This will instantly download the pre-built `dev-python` and `dev-node` images and start all three `duras-agv` services (`api`, `app`, `website`) in an integrated environment.
